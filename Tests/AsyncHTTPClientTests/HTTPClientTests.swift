...
class HTTPClientTests: XCTestCase {
    ...
    func testBadRequestURI() throws {
        ...
        XCTAssertNoThrow(try Request(url: "https:/foo"), "should not throw")
        XCTAssertNoThrow(try Request(url: "http+unix:///path"), "should not throw")
    }
    ...
    func testURLSocketPathInitializers() throws {
        ...
        if let url = url1 {
            ...
            XCTAssertEqual(url.hostname.percentUnescaped, "/tmp/file")
            XCTAssertEqual(url.pathname, "/")
            XCTAssertEqual(url.description, "http+unix://%2Ftmp%2Ffile/")
        }
        ...
        if let url = url2 {
            XCTAssertEqual(url.scheme, "http+unix:")
            XCTAssertEqual(url.hostname.percentUnescaped, "/tmp/file")
            XCTAssertEqual(url.pathname, "/file/path")
            XCTAssertEqual(url.description, "http+unix://%2Ftmp%2Ffile/file/path")
        }
        ...
        if let url = url4 {
            XCTAssertEqual(url.scheme, "http+unix:")
            XCTAssertEqual(url.hostname.percentUnescaped, "/tmp/file with spacesと漢字")
            XCTAssertEqual(url.pathname, "/file/path")
            XCTAssertEqual(url.description, "http+unix://%2Ftmp%2Ffile%20with%20spaces%E3%81%A8%E6%BC%A2%E5%AD%97/file/path")
        }
        ...
        if let url = url5 {
            ...
            XCTAssertEqual(url.hostname.percentUnescaped, "/tmp/file")
            XCTAssertEqual(url.pathname, "/")
            XCTAssertEqual(url.description, "https+unix://%2Ftmp%2Ffile/")
        }
        ...
        if let url = url6 {
            ...
            XCTAssertEqual(url.hostname.percentUnescaped, "/tmp/file")
            XCTAssertEqual(url.pathname, "/file/path")
            XCTAssertEqual(url.description, "https+unix://%2Ftmp%2Ffile/file/path")
        }
        ...
        if let url = url8 {
            ...
            XCTAssertEqual(url.hostname.percentUnescaped, "/tmp/file with spacesと漢字")
            XCTAssertEqual(url.pathname, "/file/path")
            XCTAssertEqual(url.description, "https+unix://%2Ftmp%2Ffile%20with%20spaces%E3%81%A8%E6%BC%A2%E5%AD%97/file/path")
        }
    ...
    func testUDSBasic() {
        ...
        XCTAssertNoThrow(try TemporaryFileHelpers.withTemporaryUnixDomainSocketPathName { path in
            ...
            let target = "unix://\(WebURL.percentEscapeHostname(path))"
    ...
    func testUDSSocketAndPath() {
        ...
        XCTAssertNoThrow(try TemporaryFileHelpers.withTemporaryUnixDomainSocketPathName { path in
          ...
          guard let target = WebURL("echo-uri", base: "unix://\(WebURL.percentEscapeHostname(path))"),
